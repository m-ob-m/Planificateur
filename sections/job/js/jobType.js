...
{
	let removeButton = imageButton("/Planificateur/images/cancel16.png", "Supprimer", removeJobType, [], block)
	.css({"float": "right", "margin-left": "10px", "color": "#FFFFFF"});
	let modifyButton = imageButton("/Planificateur/images/edit.png", "Modifier", modifyJobType, [], block)
	.css({"float": "right", "margin-left": "10px", "color": "#FFFFFF"});
...
{	
	let addButton = imageButton("/Planificateur/images/add.png", "Ajouter", addPart, [], block)
	.css({"flex": "0 1 auto", "margin-left": "10px", "color": "#FFFFFF"});
	let minusButton = imageButton("/Planificateur/images/minus.png", "Vider", emptyPartsTable, [], block)
	.css({"flex": "0 1 auto", "margin-left": "10px", "color": "#FFFFFF"});
...
{	
	...
	let modifyTool = imageButton("/Planificateur/images/edit.png", "", modifyPart, [], row).css({"margin-left": "10px"});
	let deleteTool = imageButton("/Planificateur/images/cancel16.png", "", removePart, [], row).css({"margin-left": "10px"});
